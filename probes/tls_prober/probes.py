...
class Heartbeat(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_hb_hello())
        logging.debug('Sending Heartbeat...')
        sock.send(self.make_heartbeat())
...
class HighTLSVersion(Probe):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_high_tls_hello())
...
class ZeroHelloVersion(Probe):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_zero_tls_hello())
...
class BadContentType(Probe):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_bad_content_type())
...
class RecordLengthOverflow(Probe):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_record_length_overflow())
...
class RecordLengthUnderflow(Probe):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        try:
            sock.send(self.make_record_length_underflow())
        except socket.timeout as e:
            result = 'writeerror:timeout'
            return result
        except socket.error as e:
...
class EmptyRecord(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_empty_record())
        logging.debug('Sending Client Hello...')
        sock.send(self.make_hello())
...
class TwoInvalidPackets(Probe):
    ...
    def test(self, sock):
        ...
        part_one = b'<tls.record.TLSRecord object at 0x7fd2dc0906d0>'
        part_two = b'<tls.record.TLSRecord object at 0x7fd2dc090690>'
        sock.send(part_one)
        try:
            sock.send(part_two)
        except socket.timeout as e:
...
class NoCiphers(Probe):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_no_ciphers_hello())
...
class SNIWrongName(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_sni_hello('thisisnotyourname'))
...
class SNILongName(SNIWrongName):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_sni_hello('x'*500))
...
class SNIOneWrong(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_sni_hello(self.ipaddress))
...
class SNIWithDifferentType(NormalHandshake):
    ...
    def make_sni_ext(self, server_names):
        encoded_names = b''.join(struct.pack('!BH', name_type, len(name))
                                + str.encode(name) for name_type, name in server_names)
    ...
    def test(self, sock):
        ...
        sock.send(self.make_sni_hello(server_names))
...
class SNIUnderflow(SNIOverflow):
    ...
    def make_sni_hello(self, name):
        ...
        ext_data = sni_extension.bytes[4:] + b'\x00\x00\x00'
        sni_extension = Extension.create(extension_type=Extension.ServerName,
                                         data=ext_data)
...
class SecureRenegoOverflow(NormalHandshake):
    ...
    def test(self, sock):
        ...
        # required amount
        sock.send(self.make_secure_renego_ext(b'\x0c0123456789'))
...
class SecureRenegoUnderflow(SecureRenegoOverflow):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_secure_renego_ext(b'\x00\x00\x00\x00\x00'))
...
class SecureRenegoNonEmpty(SecureRenegoOverflow):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_secure_renego_ext(b'\x0c012345678901'))
...
class SecureRenegoNull(SecureRenegoOverflow):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_secure_renego_ext(b''))
...
class MaxFragmentNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_fragment_hello(b''))
...
class MaxFragmentInvalid(MaxFragmentNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_fragment_hello(b'\x08'))
...
class ClientCertURLsNotNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_cert_urls_hello(b'\x08\x00'))
...
class TrustedCANull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_trusted_ca_hello(b''))
...
class TrustedCAOverflow(TrustedCANull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_trusted_ca_hello(b'\x00\x15'))
...
class TrustedCAUnderflow(TrustedCANull):
    ...
    def test(self, sock):
        ...
        authority = b'\x01' + b'a'*20
        # payload has a 2 byte length and then an array of items,
        # add null byte at end to cause the underflow
        ext_data = struct.pack('!H', len(authority)) + authority + b'\x00'

        sock.send(self.make_trusted_ca_hello(ext_data))
...
class TruncatedHMACNotNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_truncated_hmac_hello(b'\x0c'))
...
class OCSPNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        # it
        sock.send(self.make_ocsp_hello(b''))
...
class OCSPOverflow(OCSPNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_ocsp_hello(b'\x01\x00\x00\x00'))
...
class OCSPUnderflow(OCSPNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_ocsp_hello(b'\x01' + b'\x00' * 6))
...
class DoubleExtension(NormalHandshake):
    ...
    def test(self, sock):
        ...
        # of the same type
        sock.send(self.make_double_ext_hello())
...
class UserMappingNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_user_mapping_ext(b''))
...
class UserMappingOverflow(UserMappingNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_user_mapping_ext(b'\x02\x40'))
...
class ClientAuthzNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_client_authz_hello(b''))
...
class ClientAuthzOverflow(ClientAuthzNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_client_authz_hello(b'\x04\x00\x01'))
...
class CertTypeNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension has an array, don't send anything
        sock.send(self.make_cert_type_hello(b''))
...
class CertTypeOverflow(CertTypeNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_cert_type_hello(b'\x04\x01'))
...
class SupportedGroupsNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension has an array, don't send anything
        sock.send(self.make_supported_groups_hello(b''))
...
class SupportedGroupsOddLen(SupportedGroupsNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_supported_groups_hello(b'\x00\x03\x00\x17\x00'))
...
class SupportedGroupsOverflow(SupportedGroupsNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_supported_groups_hello(b'\x00\x04\x00\x17'))
...
class ECPointFormatsNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension has an array, don't send anything
        sock.send(self.make_point_formats_hello(b''))
...
class ECPointFormatsOverflow(ECPointFormatsNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_point_formats_hello(b'\x04\x00'))
...
class ECPointFormatsCompOnly(ECPointFormatsNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_point_formats_hello(b'\x02\x01\x02'))
...
class SRPNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_srp_hello(b''))
...
class SRPOverflow(SRPNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_srp_hello(b'\x06test'))
...
class SigAlgsNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension has an array, don't send anything
        sock.send(self.make_signature_alg_hello(b''))
...
class SigAlgsOddLen(SigAlgsNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_signature_alg_hello(b'\x00\x05'
                                                 b'\x04\x01'
                                                 b'\x04\x03\x04'))
...
class SigAlgsOverflow(SigAlgsNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_signature_alg_hello(b'\x00\x06'
                                                 b'\x04\x01'
                                                 b'\x04\x03'))
...
class UseSrtpNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension has an array, don't send anything
        sock.send(self.make_use_srtp_hello(b''))
...
class UseSrtpOddLen(UseSrtpNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_use_srtp_hello(b'\x00\x05'
...
class UseSrtpOverflow(UseSrtpNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_use_srtp_hello(b'\x00\x06'
                                            b'\x00\x01\x00\x05'))
...
class HeartbeatNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_heartbeat_hello(b''))
...
class HeartbeatInvalid(HeartbeatNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_heartbeat_hello(b'\x00'))
...
class ALPNNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_alpn_hello(b''))
...
class ALPNUnknown(ALPNNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_alpn_hello(b'\x00\x08'
                                        b'\x07unknown'))
...
class ALPNOverflow(ALPNNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_alpn_hello(b'\x00\x10'
                                        b'\x08http/1.1'))
...
class OCSPv2Null(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_ocspv2_hello(b''))
...
class OCSPv2Overflow(OCSPv2Null):
    ...
    def test(self, sock):
        ...
        data = (b'\x00\x10'  # overall length of extension (too large)
                ...
                b'\x00\x00'  # responder ID list length
                b'\x00\x00')  # request extensions list length
        sock.send(self.make_ocspv2_hello(data))
...
class SignedCertTSNotNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_signed_cert_ts_hello(b'\x04'))
...
class ClientCertTypeNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_client_cert_type_hello(b''))
...
class ClientCertTypeOverflow(ClientCertTypeNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_client_cert_type_hello(b'\x04\x02\x01\x00'))
...
class ServerCertTypeNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # valid extension has an array
        sock.send(self.make_server_cert_type_hello(b''))
...
class ServerCertTypeOverflow(ServerCertTypeNull):
    ...
    def test(self, sock):
        logging.debug('sending Client Hello...')
        # first byte is the length of the array, send too large
        sock.send(self.make_server_cert_type_hello(b'\x04\x02\x01\x00'))
...
class PaddingNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_padding_hello(b''))
...
class Padding300Byte(PaddingNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_padding_hello(b'\x00' * (300 - (64 - 5) - 4)))
...
class Padding300Byte12(PaddingNull, NormalHandshake12):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (300 - (88 - 5) - 4)))
...
class Padding300Byte12PFS(PaddingNull, NormalHandshake12PFS):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (300 - (144 - 5) - 4)))
...
class Padding600Byte(PaddingNull):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (600 - (64 - 5) - 4)))
...
class Padding600Byte12(PaddingNull, NormalHandshake12):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (600 - (88 - 5) - 4)))
...
class Padding600Byte12PFS(PaddingNull, NormalHandshake12PFS):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (600 - (144 - 5) - 4)))
...
class Padding16384Byte(PaddingNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_padding_hello(b'\x00' * (16384 - (64 - 5) - 4)))
...
class Padding16384Byte12(PaddingNull, NormalHandshake12):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (16384 - (88 - 5) - 4)))
...
class Padding16384Byte12PFS(PaddingNull, NormalHandshake12PFS):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (16384 - (144 - 5) - 4)))
...
class Padding16385Byte(Probe):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (16385 - (64 - 5) - 4)))
...
class Padding16385Byte12(Padding16385Byte):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (16385 - (88 - 5) - 4)))
...
class Padding16385Byte12PFS(Padding16385Byte):
    ...
    def test(self, sock):
        ...
        # record layer overhead, extensions length is already included
        # but extension id and extension length is not, totalling 4 bytes
        sock.send(self.make_padding_hello(b'\x00' * (16385 - (144 - 5) - 4)))
...
class Padding16387Byte(Padding16385Byte):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (16387 - (64 - 5) - 4)))
...
class Padding16387Byte12(Padding16385Byte12):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (16387 - (88 - 5) - 4)))
...
class Padding16387Byte12PFS(Padding16385Byte12PFS):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (16387 - (144 - 5) - 4)))
...
class Padding16389Byte(Padding16385Byte):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (16389 - (64 - 5) - 4)))
...
class Padding16389Byte12(Padding16385Byte12):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (16389 - (88 - 5) - 4)))
...
class Padding16389Byte12PFS(Padding16385Byte12PFS):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (16389 - (144 - 5) - 4)))
...
class Padding17520Byte(Padding16385Byte):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (17520 - (64 - 5) - 4)))
...
class Padding17520Byte12(Padding16385Byte12):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (17520 - (88 - 5) - 4)))
...
class Padding17520Byte12PFS(Padding16385Byte12PFS):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        sock.send(self.make_padding_hello(b'\x00' * (17520 - (144 - 5) - 4)))
...
class EtMNotNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_etm_hello(b'\x04'))
...
class EMSNotNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension must be empty
        sock.send(self.make_ems_hello(b'\x04'))
...
class CachedInfoNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_cached_info_hello(b''))
...
class CachedInfoOverflow(CachedInfoNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_cached_info_hello(b'\x00\x44'
                                               b'\x02'  # type cert_req
...
class SessionTicketNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_session_ticket_hello(b''))
...
class SessionTicketOverflow(SessionTicketNull):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_session_ticket_hello(b'\x02\x00' +
                                                  b'\xe7' * 0xff))
...
class NPNNotNull(NormalHandshake):
    ...
    def test(self, sock):
        ...
        sock.send(self.make_npn_hello(b'\x04'))
...
class TACKNotNull(NormalHandshake):
    ...
    def test(self, sock):
        logging.debug('Sending Client Hello...')
        # normal extension must be empty
        sock.send(self.make_tack_hello(b'\x08'))
